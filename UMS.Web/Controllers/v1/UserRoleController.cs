...
namespace UMS.Web.Controllers.v1
{
	...
	public class UserRoleController : BaseController<UMSDbContext, AppUserRole>
	{
        ...
        public override IActionResult Create(AppUserRole obj)
        {
            return base.Create(obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Update([FromRoute] string id, [FromBody] AppUserRole obj)
        {
            return base.Update(id, obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Disable([FromRoute] string id, [FromBody] AppUserRole obj)
        {
