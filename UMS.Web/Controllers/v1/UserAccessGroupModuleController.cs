...
namespace UMS.Web.Controllers.v1
{
    ...
    public class UserAccessGroupModuleController : BaseController<UMSDbContext, AppUserAccessGroupModule>
    {
        ...
        public override IActionResult Create(AppUserAccessGroupModule obj)
        {
            return base.Create(obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Update([FromRoute] string id, [FromBody] AppUserAccessGroupModule obj)
        {
            return base.Update(id, obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Disable([FromRoute] string id, [FromBody] AppUserAccessGroupModule obj)
        {
