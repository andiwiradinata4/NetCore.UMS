...
namespace UMS.Web.Controllers.v1
{
    ...
    public class UserAccessGroupController : BaseController<UMSDbContext, AppUserAccessGroup>
    {
        ...
        public override IActionResult Create(AppUserAccessGroup obj)
        {
            return base.Create(obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Update([FromRoute] string id, [FromBody] AppUserAccessGroup obj)
        {
            return base.Update(id, obj);
        }

        [Authorize(Roles = "IT-SUPPORT")]
        public override IActionResult Disable([FromRoute] string id, [FromBody] AppUserAccessGroup obj)
        {
